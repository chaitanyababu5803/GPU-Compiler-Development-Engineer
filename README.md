...
Rust: Rapidly becoming a "power move" for memory-safe systems programming and next-gen infrastructure.
Mojo: A rising challenger designed specifically for high-performance AI kernels and heterogeneous computing, aiming to be 35,000x faster than standard Python. 
...
Triton: OpenAI’s Python-based language that handles GPU optimizations automatically; expected to be a primary tool by 2026.
...
Advanced Compilers: Build a project using LLVM or MLIR to lower a custom DSL to a GPU.
Modern GPU Coding: Transition from direct CUDA to Triton and Mojo to stay ahead of the "automation" trend.
Hardware Modeling: Learn performance modeling using simulators like GPGPU-Sim or internal tools at firms like NVIDIA. 
Are you focusing on front-end language design (semantics/type systems) or back-end code generation and hardware optimization?
